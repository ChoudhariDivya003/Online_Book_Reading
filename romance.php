    ...
    <section>
      <div class="book-list">
        ...
        <div class="book">
            ...
            <h3 class="book-title"><a href="PDF/It-Ends-With-Us.pdf" class="name">It Ends With Us</a></h3>
            <p class="book-author">Colleen Hoover</p>
        </div>
        <div class="book">
            <img src="bookweb/pride-prejudice-13.jpg" alt="Book 3">
            <h3 class="book-title"><a href="PDF/Pride-and-Prejudice.pdf" class="name">Pride And Prejudice</a></h3>
